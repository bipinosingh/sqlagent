...
namespace SqlAgent.Services
{
    public class AIService
    {
        ...
        public async Task<string> CorrectSqlAsync(
            string question,
            string schema,
            string failedSql,
            string error)
        {
            ...
            A SQL query generated by another AI failed.
        ...
        public async Task<string?> ValidateQuestionAsync(
            string question,
            List<string> columns)
        {
            var prompt = $@"
                You are validating a database question.
                ...
                If the question asks for a column that does NOT exist,
                reply ONLY with its name.
            ...
            var response = await _chatClient.CompleteChatAsync(
                new List<ChatMessage>
                {
                    ChatMessage.CreateSystemMessage("Validate questions."),
                    ChatMessage.CreateUserMessage(prompt)
                  });
